...
const departmentData = {
    id: 1,
    name: 'Engineering',
    description: 'Responsible for developing and maintaining software products and internal tools.',
    manager: 'Robert Chen',
    employeeCount: 42,
...
export default function DepartmentDetailPage({ params }: { params: { id: string } }) {
    ...
    const handleTransfer = (employeeId: number, targetDepartmentId: number) => {
        console.log(`Transfer employee ${employeeId} to department ${targetDepartmentId}`);
    ...
    return (
        <MainLayout activePath="/departments">
            ...
            {/* Transfer Modal */}
            <Modal opened={showTransferModal} onClose={() => { setShowTransferModal(false); setSelectedEmployee(null); }} title="Transfer Employee" centered>
                <p className="text-sm text-gray-600 mb-4">Select a department to transfer the employee to:</p>
            ...
            {/* Add Employee Modal */}
            <Modal opened={showAddModal} onClose={() => setShowAddModal(false)} title="Add New Employee" centered>
                <form onSubmit={(e) => { e.preventDefault(); handleAdd(); }} className="space-y-4">
                    ...
                    <div>
                        ...
                        <Autocomplete
                            data={[...new Set(department.employees.map(emp => emp.position))]}
